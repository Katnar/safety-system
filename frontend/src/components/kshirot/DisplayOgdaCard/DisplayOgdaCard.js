                ...
                <>
                    <Card>
                        <CardHeader style={{ direction: 'rtl' }}>
                            <CardTitle tag="h4" style={{ direction: 'rtl', textAlign: 'right' }}><Link style={{ color: "black" }} to={`/userogdaeditpage/${ogda._id}`}>{ogda.name}</Link></CardTitle>
                        </CardHeader>
                        ...
                        <CardBody style={{ direction: 'ltr', textAlign: 'right' }}>
                            <Row style={{ direction: 'rtl', textAlign: 'center' }}>
                                ...
                                <Col xs={12} md={4}>
                                    <h5 style={{ color: '#b5ff00' }}>&#9632; ציון מטא"ג אוגדתי</h5>
                                </Col>
                            </Row>
                            ...
                            {ogdakshirot != 'NaN' ?
                                <h4 style={{ color: "#fa1251", margin: '0px' }}>{ogdakshirot.toFixed(2)}:ציון כשירות גדודים באוגדה</h4>
                                : <h4 style={{ color: "#fa1251", margin: '0px' }}>:ציון כשירות גדודים באוגדה</h4>
                            }
                            {ogdatraining != 'NaN' ?
                                <h4 style={{ color: "#00edf5", margin: '0px' }}>{ogdatraining.toFixed(2)}:ציון אימוני גדוד באוגדה</h4>
                                : <h4 style={{ color: "#00edf5", margin: '0px' }}>:ציון אימוני גדוד באוגדה</h4>
                            }
                            <h4 style={{ color: "#b5ff00", margin: '0px' }}>{ogdamatag.toFixed(2)}:ציון מטא"ג אוגדתי</h4>
                        </CardBody>
                    </Card>
                </>
                : <>
