                  ...
                  <tr {...row.getRowProps()}>
                    ...
                    {row.id != '0' ?
                      <td role="cell" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                           <Link to={`/editkshirotonly/${row.original._id}/${gdod._id}`}><button className="btn btn-success" style={{padding:'0.5rem'}}><img src={editpic} alt="bookmark" style={{height:'2rem'}}/></button></Link> 
                           <Link><button className="btn btn-danger" style={{padding:'0.5rem'}} onClick={() => KshirotDelete(row.original._id)}><img src={deletepic} alt="bookmark" style={{height:'2rem'}}/></button></Link>
                      </td>
                      :
                      <td role="cell"  style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                           <Link to={`/editkshirotonly/${row.original._id}/${gdod._id}`}><button className="btn btn-success" style={{padding:'0.5rem'}}><img src={editpic} alt="bookmark" style={{height:'2rem'}}/></button></Link> 
