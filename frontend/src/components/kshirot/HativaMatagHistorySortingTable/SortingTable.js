                  ...
                  <tr {...row.getRowProps()}>
                    ...
                    {row.id != '0' ?
                      <td role="cell" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <Link to={`/editmatagonly/${row.original._id}/${hativa._id}`}><button className="btn btn-success" style={{padding:'0.5rem'}}><img src={editpic} alt="bookmark" style={{height:'2rem'}}/></button></Link>
                        <Link><button className="btn btn-danger" onClick={() => MatagDelete(row.original._id)} style={{padding:'0.5rem'}}><img src={deletepic} alt="bookmark" style={{height:'2rem'}}/></button></Link>
                      </td>
                      :
                      <td role="cell">
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}> <Link to={`/editmatagonly/${row.original._id}/${hativa._id}`}><button className="btn btn-success" style={{padding:'0.5rem'}}><img src={editpic} alt="bookmark" style={{height:'2rem'}}/></button></Link> </div>
                      </td>
                    }
                  </tr>
                )
