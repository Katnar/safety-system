                ...
                <>
                    <Card>
                        <CardHeader style={{ direction: 'rtl' }}>
                            <CardTitle tag="h4" style={{ direction: 'rtl', textAlign: 'right' }}><Link style={{ color: "black" }} to={`/userhativaeditpage/${hativa._id}`}>{hativa.name}</Link></CardTitle>
                        </CardHeader>

                        <CardBody style={{ direction: 'ltr', textAlign: 'right' }}>
                            <Row style={{ direction: 'rtl', textAlign: 'center' }}>
                                <Col xs={12} md={4}>
                                    <h5 style={{ color: '#fa1251' }}>&#9632; ציון כשירויות</h5>
                                </Col>
                                <Col xs={12} md={4}>
                                    <h5 style={{ color: '#00edf5' }}>&#9632; ציון אימונים</h5>
                                </Col>
                                <Col xs={12} md={4}>
                                    <h5 style={{ color: '#b5ff00' }}>&#9632; ציון מטא"ג חטיבתי</h5>
                                </Col>
                            </Row>
                            ...
                            {hativagdodsfinalkshirotgrade != 'NaN' ?
                                <h4 style={{ color: "#fa1251", margin: '0px' }}>{hativagdodsfinalkshirotgrade}:ציון כשירות גדודים בחטיבה</h4>
                                : <h4 style={{ color: "#fa1251", margin: '0px' }}>:ציון כשירות גדודים בחטיבה</h4>
                            }
                            {hativagdodsfinaltraininggrade != 'NaN' ?
                                <h4 style={{ color: "#00edf5", margin: '0px' }}>{hativagdodsfinaltraininggrade}:ציון אימוני גדוד בחטיבה</h4>
                                : <h4 style={{ color: "#00edf5", margin: '0px' }}>:ציון אימוני גדוד בחטיבה</h4>
                            }
                            <h4 style={{ color: "#b5ff00", margin: '0px' }}>{hativamatagsum}:ציון מטא"ג חטיבתי</h4>
