            ...
            {isOpen ? ( //card is open
                <Card>
                    <CardHeader style={{ direction: 'rtl' }} onClick={(e) => togglePanel(e)} style={{ direction: "rtl", cursor: 'pointer', textAlign: 'center' }}>
                        <CardTitle tag="h4" style={{ direction: 'rtl', textAlign: 'right' }}><Link style={{ color: "black" }} to={`/usergdodeditpage/${gdod._id}`}>{gdod.name}</Link></CardTitle>
                    </CardHeader>
                    ...
                    <CardBody style={{ direction: 'ltr', textAlign: 'right' }} onClick={(e) => togglePanel(e)} style={{ direction: "rtl", cursor: 'pointer', textAlign: 'center' }}>
                        ...
                        <h4 style={{ color: "#fa1251" }}>{gdodkshirotsum}:ציון כשירות</h4>
                        <div className="chart-area">
                            <GdodKshirotHistoryGraph gdodid={id} />
                        </div>

                        <h4 style={{ color: "#00edf5" }}>{gdodtrainingsum}:ציון אימון</h4>
                        <div className="chart-area">
