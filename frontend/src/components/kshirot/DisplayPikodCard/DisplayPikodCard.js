                ...
                <>
                    <Card>
                        <CardHeader style={{ direction: 'rtl' }}>
                            <CardTitle tag="h4" style={{ direction: 'rtl', textAlign: 'right' }}><Link style={{ color: "black" }} to={`/userpikodeditpage/${pikod._id}`}>{pikod.name}</Link></CardTitle>
                        </CardHeader>
                        ...
                        <CardBody style={{ direction: 'ltr', textAlign: 'right' }}>
                            <Row style={{ direction: 'rtl', textAlign: 'center' }}>
                                ...
                                <Col xs={12} md={4}>
                                    <h5 style={{ color: '#b5ff00' }}>&#9632; ציון מטא"ג בפיקוד</h5>
                                </Col>
                            </Row>
                            ...
                            {pikodkshirot != 'NaN' ?
                                <h4 style={{ color: "#fa1251", margin: '0px' }}>{pikodkshirot.toFixed(2)}:ציון כשירות גדודים בפיקוד</h4>
                                : <h4 style={{ color: "#fa1251", margin: '0px' }}>:ציון כשירות גדודים בפיקוד</h4>
                            }
                            {pikodtraining != 'NaN' ?
                                <h4 style={{ color: "#00edf5", margin: '0px' }}>{pikodtraining.toFixed(2)}:ציון אימוני גדוד בפיקוד</h4>
                                : <h4 style={{ color: "#00edf5", margin: '0px' }}>:ציון אימוני גדוד בפיקוד</h4>
                            }
                            <h4 style={{ color: "#b5ff00", margin: '0px' }}>{pikodmatag.toFixed(2)}:ציון מטא"ג בפיקוד</h4>
                        </CardBody>
                    </Card>
                </>
                : <>
