            ...
            <Nav style={{ textAlign: "right", display: "block", padding: '0px' }}>
                ...
                <li style={{ paddingTop: '15px' }}>
                    <Navbar style={{ display: "block", cursor: "pointer", margin: "0px", paddingRight: "22px", }}>
                        <NavLink to={`/workplantablehativa/${user.hativaid}`} className="nav-link">
                ...
                <li>
                    <Navbar style={{ display: "block", cursor: "pointer", margin: "0px", paddingRight: "22px", }}>
                        <NavLink to={`/userhativaeditpage/${user.hativaid}`} className="nav-link">
                            <Row style={{ justifyContent: 'right' }}>
                ...
                <li>
                    <Navbar style={{ display: "block", cursor: "pointer", margin: "0px", paddingRight: "22px", }}>
                        <NavLink to={`/hativadashboard/${user.hativaid}`} className="nav-link">
                            <Row style={{ justifyContent: 'right' }}>
