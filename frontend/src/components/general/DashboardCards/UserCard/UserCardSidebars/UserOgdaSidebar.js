            ...
            <Nav style={{ textAlign: "right", display: "block", padding: '0px' }}>
                ...
                <li style={{ paddingTop: '15px' }}>
                    <Navbar style={{ display: "block", cursor: "pointer", margin: "0px", paddingRight: "22px", }}>
                        <NavLink to={`/workplantableogda/${user.ogdaid}`} className="nav-link">
                ...
                <li>
                    <Navbar style={{ display: "block", cursor: "pointer", margin: "0px", paddingRight: "22px", }}>
                        <NavLink to={`/userogdaeditpage/${user.ogdaid}`} className="nav-link">
                            <Row style={{ justifyContent: 'right' }}>
                ...
                <li>
                    <Navbar style={{ display: "block", cursor: "pointer", margin: "0px", paddingRight: "22px", }}>
                        <NavLink to={`/ogdadashboard/${user.ogdaid}`} className="nav-link">
                            <Row style={{ justifyContent: 'right' }}>
