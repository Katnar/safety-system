...
const AdminCardWork = (props) => {
  ...
  return (
    <Card style={{ textAlign: 'center', background: 'linear-gradient(0deg, rgb(255 39 107) 0%, rgb(225 78 78) 100%)', borderRadius: '40px', height: '100%', boxShadow: "0 5px 15px 0 rgb(0 0 0 / 10%), 0 5px 15px 0 rgb(0 0 0 / 15%)" }}>
