...
const AdminCardZminot = (props) => {
  ...
  return (
    <Card style={{ textAlign: 'center', background: 'linear-gradient(0deg, rgb(84 162 245) 0%, rgb(78 95 225) 100%)', borderRadius: '40px', height: '100%',boxShadow:"0 5px 15px 0 rgb(0 0 0 / 10%), 0 5px 15px 0 rgb(0 0 0 / 15%)" }}>
