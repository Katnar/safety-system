                ...
                <tr {...row.getRowProps()}>
                  {row.cells.map((cell) => {
                    ...
                    if (cell.column.id == "_id") {
                      return <td><a href={"http://localhost:8000/api/downloadFile?collec=equipmentAndMaterialsPeriodicInspections&id="+cell.value.toString()} target="_blank"><FaFileDownload/></a></td>;
                    }
