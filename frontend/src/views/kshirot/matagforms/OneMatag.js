                ...
                {id != null ?
                    <>
                        <Card>
                            ...
                            {matagsum ?
                                    matagsum < 50 ?
                                        <Progress color="danger" value={matagsum} style={{height:'2rem'}}>{matagsum.toString().slice(0, 4)}%</Progress>
                                        : matagsum < 75 ?
                                            <Progress color="warning" value={matagsum} style={{height:'2rem'}}>{matagsum.toString().slice(0, 4)}%</Progress>
                                            : matagsum < 100 ?
                                                <Progress color="success" value={matagsum} style={{height:'2rem'}}>{matagsum.toString().slice(0, 4)}%</Progress>
                                                : null
                                    : null}
                            </CardBody>
                        </Card>
