                ...
                {id != null ?
                    <>
                        <Card>
                            ...
                            {trainingsum ?
                                    trainingsum < 50 ?
                                        <Progress color="danger" value={trainingsum} style={{height:'2rem'}}>{trainingsum.toString().slice(0, 4)}%</Progress>
                                        : trainingsum < 75 ?
                                            <Progress color="warning" value={trainingsum} style={{height:'2rem'}}>{trainingsum.toString().slice(0, 4)}%</Progress>
                                            : trainingsum < 100 ?
                                                <Progress color="success" value={trainingsum} style={{height:'2rem'}}>{trainingsum.toString().slice(0, 4)}%</Progress>
                                                : null
                                    : null}
                            </CardBody>
                        </Card>
